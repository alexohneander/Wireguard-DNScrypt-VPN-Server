...
echo -e " ${GRAYB}#${ENDCOLOR} ${GREEN}More information: https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server ${ENDCOLOR}${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}##############################################################################${ENDCOLOR}"
echo -e " ${GRAYB}#${ENDCOLOR}                 Version 2022.05.06 - changelog on gitlab                   ${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}##############################################################################${ENDCOLOR}"
echo ""
echo ""
echo ""
...
if [[ -e /root/base_setup.README ]]; then
	 ...
	 echo ""
	 echo ""
	 wget -O  base_setup.sh https://gitlab.com/zzzkeil/base_setups/-/raw/master/base_setup.sh
...
if [[ -e /root/Wireguard-DNScrypt-VPN-Server.README ]]; then
	 ...
	 echo ""
	 echo "For - News / Updates / Issues - check my gitlab site"
	 echo "https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server"
	 echo
	 echo
	 exit 1
fi
...
curl -o add_client.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/tools/add_client.sh
curl -o remove_client.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/tools/remove_client.sh
curl -o wg_config_backup.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/tools/wg_config_backup.sh
curl -o wg_config_restore.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/tools/wg_config_restore.sh
curl -o uninstaller_back_to_base.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/tools/uninstaller_back_to_base.sh
...
curl -o /etc/unbound/unbound.conf https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/configs/unbound.conf
...
curl -o /etc/dnscrypt-proxy/dnscrypt-proxy.toml https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/configs/dnscrypt-proxy.toml
curl -o /etc/dnscrypt-proxy/dnscrypt-proxy-update.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/configs/dnscrypt-proxy-update.sh
...
curl -o /etc/dnscrypt-proxy/utils/generate-domains-blocklists/domains-blocklist.conf https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/blocklist/domains-blocklist-default.conf
...
curl -o /etc/dnscrypt-proxy/allowed-names.txt https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/blocklist/domains-allowed-names.txt
nano /etc/dnscrypt-proxy/allowed-names.txt
## check if generate blocklist failed - file is empty
curl -o /etc/dnscrypt-proxy/checkblocklist.sh https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/configs/checkblocklist.sh
...
curl -o /lib/systemd/system/unbound.service https://gitlab.com/zzzkeil/Wireguard-DNScrypt-VPN-Server/-/raw/master/configs/unbound.service
